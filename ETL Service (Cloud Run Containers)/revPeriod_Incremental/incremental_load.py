...
def incremental_load():
    ...
    query = """  SELECT RP.*,CT.SYS_CHANGE_OPERATION AS OperationFlag
    FROM [Finance].[RevenuePeriod] AS RP
    INNER JOIN CHANGETABLE(CHANGES [Finance].[RevenuePeriod], 0) AS CT
    ON RP.RevenuePeriodId = CT.RevenuePeriodId;"""
